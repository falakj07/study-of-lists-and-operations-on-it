...
Daily temperature readings of a city are stored
...
## Conclusion - A list is a built-in data structure in Python and Indexing allows access to individual elements of a list.Slicing is used to extract a portion (sublist) from a list.
